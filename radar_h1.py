...
TELEGRAM_THREAD_ID_CLIENTES_H1   = os.environ.get("TELEGRAM_THREAD_ID_CLIENTES_H1")
...
def send_telegram(msg: str, chat_id: str = None, thread_id: str = None):
    """chat_id/thread_id opcionais — por padrão manda pro destino H1 de
    ...
    destino = chat_id or TELEGRAM_CHAT_ID_H1
    payload = {"chat_id": destino, "text": msg, "parse_mode": "Markdown"}
    thread = TELEGRAM_THREAD_ID_H1 if chat_id is None else thread_id
    if thread:
