...
# Lista de Tickers para checar (agora inclui "EME")
TICKERS = [
...
def check_symbol(sym):
    ...
    # Condições: acima das 3 médias diárias e semanais, e fechamento diário positivo
    cond_d = (
